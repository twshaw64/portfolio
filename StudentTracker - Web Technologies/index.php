...
<body>
	...
	<div class="locationForm">
		<form action="databaseInsert.php" method="POST" align = "center">
				...
				<input name="forename" placeholder="Forename" class="textbox" required pattern="[A-za-z]{0-50}" title="Forename"/>
				<input name="surname" placeholder="Surname" class="textbox" required pattern="[A-za-z]{0-50}" title="Surname"/>
