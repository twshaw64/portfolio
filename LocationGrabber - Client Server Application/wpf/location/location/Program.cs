...
namespace location
{
    ...
    {
        [DllImport("kernel32.dll")] //this allows output to the console launching the application
        ...
        public static string Main(string[] args)
        {
            try
            {
                AttachConsole(ATTACH_PARENT_PROCESS); // attaches the application to the console window that opened it

                Parameters p = new Parameters(args, "whois.net.dcs.hull.ac.uk", 43, 3000, null, null, Protocol.whois);
                    ...
                    case Protocol.whois:
                        ...
                        else
                        {
                            ...
                            if (Response2(sr, p, "OK"))
                            {
                                ...
                                return (p.user + " location changed to be " + p.location);
                            }
                    ...
                    case Protocol.HTTP09:
                        if (p.location == null) //GET
                        {
                            ...
                            if (Response2(sr, p, "HTTP/0.9 200 OK"))
                            {
                                ...
                                return (p.user + " is " + p.location);
                            }
                            else { return "ERROR: no entries found"; }
                        }
                        else //PUT
                        {
